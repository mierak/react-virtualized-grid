...
var Cell = function (props) {
    ...
    return (React__default.createElement("div", { className: 'cell', style: style }, props.children));
};
...
var VirtualizedGrid = function (props) {
    ...
    var _e = React.useState({ rows: 0, columns: 0 }), config = _e[0], setConfig = _e[1];
    var _f = React.useState({ from: 0, to: 30 }), fromTo = _f[0], setFromTo = _f[1];
    ...
    var renderCells = function () {
        return __spreadArrays(Array(fromTo.to - fromTo.from)).map(function (_, rowIndex) {
            return __spreadArrays(Array(config.columns)).map(function (_, cellIndex) {
                ...
                return index < props.itemCount ? (React__default.createElement(Cell, { key: cellIndex, height: props.rowHeight }, props.children(index, rowIndex + fromTo.from, cellIndex))) : null;
            });
        });
    };
    ...
    return (React__default.createElement("div", { className: "container " + ((_d = props.className) !== null && _d !== void 0 ? _d : ''), ref: gridRef, style: style, onScroll: handleScroll },
